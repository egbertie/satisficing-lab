...
- 日期: 2026-05-30
- 决策: 所有 37 个面板用 viewRenderers 对象注册，renderView() 统一路由
...
4. 37 个 viewRenderer 是否拆分到独立 JS 文件待评估

#!/usr/bin/env python3
"""
knowledge-graph 自动化测试
生成时间: 2026-04-03T14:05:59.460418
"""
...
try:
    from knowledge_graph_test import *
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestKnowledgeGraph)

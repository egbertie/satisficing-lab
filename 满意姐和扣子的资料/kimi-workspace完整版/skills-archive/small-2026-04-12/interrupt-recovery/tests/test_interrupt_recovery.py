#!/usr/bin/env python3
"""
interrupt-recovery 自动化测试
生成时间: 2026-04-03T14:05:59.460072
"""
...
try:
    from interrupt_recovery_integration import *
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestInterruptRecovery)

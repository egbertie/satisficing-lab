#!/usr/bin/env python3
"""
adversarial-test 自动化测试
生成时间: 2026-04-03T14:05:59.451357
"""
...
try:
    from run_adversarial_tests import *
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestAdversarialTest)

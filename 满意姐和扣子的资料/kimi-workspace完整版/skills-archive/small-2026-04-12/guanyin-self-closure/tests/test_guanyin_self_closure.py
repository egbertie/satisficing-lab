#!/usr/bin/env python3
"""
guanyin-self-closure 自动化测试
生成时间: 2026-04-03T14:05:59.458535
"""
...
try:
    from guanyin_self_closure import *
...
class TestGuanyinSelfClosure(unittest.TestCase):
    """guanyin-self-closure 测试套件"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestGuanyinSelfClosure)

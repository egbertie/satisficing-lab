#!/usr/bin/env python3
"""
extension-evaluator 自动化测试
生成时间: 2026-04-03T14:05:59.457315
"""
...
try:
    from extension_evaluator import *
...
class TestExtensionEvaluator(unittest.TestCase):
    """extension-evaluator 测试套件"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestExtensionEvaluator)

#!/usr/bin/env python3
"""
dialogue-token-optimizer 自动化测试
生成时间: 2026-04-03T14:05:59.456005
"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestDialogueTokenOptimizer)

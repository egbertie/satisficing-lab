#!/usr/bin/env python3
"""
mass-task-executor 自动化测试
生成时间: 2026-04-03T14:05:59.462152
"""
...
try:
    from mass_task_executor_test import *
...
class TestMassTaskExecutor(unittest.TestCase):
    """mass-task-executor 测试套件"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestMassTaskExecutor)

#!/usr/bin/env python3
"""
category6-full-task-processor 自动化测试
生成时间: 2026-04-03T14:05:59.453979
"""
...
try:
    from category6_full_task_processor_test import *
...
class TestCategory6FullTaskProcessor(unittest.TestCase):
    """category6-full-task-processor 测试套件"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestCategory6FullTaskProcessor)

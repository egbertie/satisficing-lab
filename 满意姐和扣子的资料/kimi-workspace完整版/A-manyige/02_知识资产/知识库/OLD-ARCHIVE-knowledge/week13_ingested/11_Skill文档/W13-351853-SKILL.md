---
# 知识元数据 (5标准化)
knowledge_id: W13-351853
title: SKILL
category: 11_Skill文档
source: skills/.archive_sendfiles-to-feishu/SKILL.md
...
> **知识ID**: W13-351853  
> **分类**: 11_Skill文档  
> **来源**: `skills/.archive_sendfiles-to-feishu/SKILL.md`  
> **入库时间**: 2026-03-27
...
metadata:
  {
    "openclaw":
      {
        "emoji": "📤",
        "requires": { "env": ["FEISHU_APP_ID", "FEISHU_APP_SECRET"], "bins": ["ffmpeg", "ffprobe"] },
        "install":
          [
            {
              "id": "env",
              "kind": "env",
              "vars": [
                { "name": "FEISHU_APP_ID", "label": "Feishu App ID" },
                { "name": "FEISHU_APP_SECRET", "label": "Feishu App Secret", "sensitive": true }
              ]
            }
          ],
      },

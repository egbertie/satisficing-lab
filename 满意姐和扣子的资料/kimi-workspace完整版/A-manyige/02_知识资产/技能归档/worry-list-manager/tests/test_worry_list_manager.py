#!/usr/bin/env python3
"""
worry-list-manager 自动化测试
生成时间: 2026-04-03T14:05:59.467575
"""
...
try:
    from worry_list_manager_test import *
...
class TestWorryListManager(unittest.TestCase):
    """worry-list-manager 测试套件"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestWorryListManager)

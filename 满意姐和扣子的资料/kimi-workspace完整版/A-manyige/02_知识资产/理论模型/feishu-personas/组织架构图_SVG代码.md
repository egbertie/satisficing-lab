...
<svg viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="五路图腾">
    ...
    <text x="70" y="200" text-anchor="middle" fill="white" font-size="10">刘禹锡 刘禹锡</text>
    ...
    <text x="190" y="200" text-anchor="middle" fill="white" font-size="10">司马贺 西蒙</text>
    ...
    <text x="310" y="200" text-anchor="middle" fill="white" font-size="10">观自在 观自在</text>
    ...
    <text x="430" y="200" text-anchor="middle" fill="white" font-size="10">孔子 孔子</text>
    ...
    <text x="550" y="200" text-anchor="middle" fill="white" font-size="10">六祖慧能 六祖</text>
  ...
  <!-- 底部信息 -->
  <text x="600" y="760" text-anchor="middle" font-size="12" fill="#333" font-weight="bold">五路图腾：刘禹锡(土)→司马贺(金)→观自在(水)→孔子(木)→六祖慧能(火)→刘禹锡(土)</text>

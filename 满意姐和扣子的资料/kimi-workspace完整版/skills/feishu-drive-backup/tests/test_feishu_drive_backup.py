#!/usr/bin/env python3
"""
feishu-drive-backup 自动化测试
生成时间: 2026-04-03T14:05:59.457444
"""
...
try:
    from feishu_drive_backup import *
...
class TestFeishuDriveBackup(unittest.TestCase):
    """feishu-drive-backup 测试套件"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestFeishuDriveBackup)

#!/usr/bin/env python3
"""
blue-army-interceptor 自动化测试
生成时间: 2026-04-03T14:05:59.453056
"""
...
try:
    from blue_army_interceptor import *
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestBlueArmyInterceptor)

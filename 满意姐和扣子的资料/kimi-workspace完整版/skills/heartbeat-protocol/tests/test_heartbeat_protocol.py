#!/usr/bin/env python3
"""
heartbeat-protocol 自动化测试
生成时间: 2026-04-03T14:05:59.458867
"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestHeartbeatProtocol)

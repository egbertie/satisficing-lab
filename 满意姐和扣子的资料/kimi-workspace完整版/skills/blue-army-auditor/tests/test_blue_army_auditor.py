#!/usr/bin/env python3
"""
blue-army-auditor 自动化测试
生成时间: 2026-04-03T14:05:59.452702
"""
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestBlueArmyAuditor)
